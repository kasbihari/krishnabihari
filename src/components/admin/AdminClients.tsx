  ...
  return (
    <main style={{ minHeight: '100vh', padding: '2rem 1.25rem 4rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {notice && (
          <div style={{ border: '1px solid rgba(92,158,131,0.3)', background: 'rgba(92,158,131,0.1)', color: 'var(--forest-bright)', borderRadius: '10px', padding: '0.8rem 1rem', marginBottom: '1rem', fontSize: '0.9rem' }}>
            {notice}
          </div>
        )}
        ...
        {editorOpen && (
          <div style={{ border: '1px solid var(--border-mid)', borderRadius: '18px', background: 'rgba(10,10,10,0.7)', padding: '1.5rem', marginBottom: '1.5rem', display: 'grid', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
              <button onClick={closeEditor} style={{ padding: '0.7rem 1.2rem', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)', background: 'transparent', color: 'var(--muted-light)', cursor: 'pointer', fontSize: '0.85rem' }}>
                Cancel
              </button>
              <button onClick={save} disabled={busy} style={{ padding: '0.7rem 1.4rem', borderRadius: '10px', border: '1px solid rgba(92,158,131,0.4)', background: 'rgba(92,158,131,0.2)', color: 'var(--forest-bright)', cursor: busy ? 'default' : 'pointer', fontSize: '0.85rem', fontWeight: 600, opacity: busy ? 0.6 : 1 }}>
