...
import { createTimelineEntry } from '../../../../../lib/server/client-admin';
...
export const POST: APIRoute = async ({ request, cookies, params }) => {
  ...
  if (!title) return badRequestResponse('Timeline title is required.');
  ...
  const result = await createTimelineEntry({
    ...
    timeline_date: cleanNullableString(body.timeline_date) ?? undefined,
